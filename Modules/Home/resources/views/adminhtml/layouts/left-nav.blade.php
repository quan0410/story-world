            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                <li class="nav-item"><a class="nav-link active" href="index.html">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                class="nav-link-text">Dashbboard</span></div>
                    </a></li>
                <li class="nav-item">
                    <p class="navbar-vertical-label">Pages</p><a class="nav-link" href="pages/starter.html"
                                                                 role="button" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    data-feather="flag"></span></span><span
                                class="nav-link-text">Starter</span></div>
                    </a><a class="nav-link dropdown-indicator" href="#errors" role="button"
                        ...
                        <div class="d-flex align-items-center">
                            <div class="dropdown-indicator-icon d-flex flex-center"><span
                                    class="fas fa-caret-right fs-0"></span></div><span
                    ...
                    </ul><a class="nav-link dropdown-indicator" href="#authentication" role="button"
                    ...
                    <ul class="nav collapse parent" id="authentication">
                        ...
                        <li class="nav-item"><a class="nav-link"
                                                href="pages/authentication/simple/lock-screen.html" data-bs-toggle=""
                                                aria-expanded="false">
                ...
                <li class="nav-item">
                    <p class="navbar-vertical-label">Modules</p><a class="nav-link dropdown-indicator"
                                                                   href="#forms" role="button" data-bs-toggle="collapse" aria-expanded="false"
                                                                   aria-controls="forms">
                        <div class="d-flex align-items-center">
                            <div class="dropdown-indicator-icon d-flex flex-center"><span
                                    class="fas fa-caret-right fs-0"></span></div><span
                    ...
                    <ul class="nav collapse parent" id="forms">
                        <li class="nav-item"><a class="nav-link" href="modules/forms/form-control.html"
                                                data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Form
                                                    control</span></div>
                            </a></li>
                        <li class="nav-item"><a class="nav-link" href="modules/forms/input-group.html"
                                                data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Input
                                                    group</span></div>
                            </a></li>
                        <li class="nav-item"><a class="nav-link" href="modules/forms/select.html"
                                                data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span
                                        class="nav-link-text">Select</span></div>
                            </a></li>
                        <li class="nav-item"><a class="nav-link" href="modules/forms/checks.html"
                                                data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span
                                        class="nav-link-text">Checks</span></div>
                            </a></li>
                        <li class="nav-item"><a class="nav-link" href="modules/forms/range.html"
                                                data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span
                                        class="nav-link-text">Range</span></div>
                            </a></li>
                        <li class="nav-item"><a class="nav-link" href="modules/forms/layout.html"
                                                data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span
                    ...
                    </ul><a class="nav-link dropdown-indicator" href="#tables" role="button"
                    ...
                    </ul><a class="nav-link dropdown-indicator" href="#components" role="button"
                    ...
                    <ul class="nav collapse parent" id="components">
                        ...
                        <li class="nav-item"><a class="nav-link" href="modules/components/carousel.html"
                                                data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span
                                        class="nav-link-text">Carousel</span></div>
                            </a></li>
                    ...
                    </ul><a class="nav-link dropdown-indicator" href="#utilities" role="button"
                    ...
                    </ul><a class="nav-link dropdown-indicator" href="#multi-level" role="button"
                                        ...
                                        <li class="nav-item"><a class="nav-link dropdown-indicator"
                                            ...
                                            <ul class="nav collapse parent" id="item-9">
                                                <li class="nav-item"><a class="nav-link" href="#!.html"
                                                                        data-bs-toggle="" aria-expanded="false">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Item 10</span></div>
                                                    </a></li>
                                                <li class="nav-item"><a class="nav-link" href="#!.html"
                                                                        data-bs-toggle="" aria-expanded="false">
                                                        <div class="d-flex align-items-center"><span
                                                                class="nav-link-text">Item 11</span></div>
                                                    </a></li>
                                            </ul>
                                        </li>
                                    </ul>
                ...
                <li class="nav-item">
                    <p class="navbar-vertical-label">Documentation</p><a class="nav-link"
                                                                         href="documentation/getting-started.html" role="button" data-bs-toggle=""
                                                                         aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    data-feather="life-buoy"></span></span><span
                                class="nav-link-text">Getting started</span></div>
                    </a><a class="nav-link dropdown-indicator" href="#customization" role="button"
                    ...
                    </ul><a class="nav-link" href="documentation/webpack.html" role="button"
                            data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    data-feather="hexagon"></span></span><span
                                class="nav-link-text">Webpack</span></div>
                    </a><a class="nav-link" href="documentation/design-file.html" role="button"
                           data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    data-feather="figma"></span></span><span class="nav-link-text">Design
                                            file</span></div>
                    </a><a class="nav-link" href="changelog.html" role="button" data-bs-toggle=""
                           aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    data-feather="git-merge"></span></span><span
                                class="nav-link-text">Changelog</span></div>
                    </a>
                </li>
            </ul>
        </div>
